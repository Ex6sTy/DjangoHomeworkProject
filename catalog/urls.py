...
from .views import HomeView, ContactView, ProductDetailView, ProductCreateView, ProductDeleteView, ProductUpdateView, ProductUnpublishView, CategoryProductListView
